...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>CHAT.USER_NAME</code>.
     */
    public final TableField<ChatRecord, String> USER_NAME = createField(DSL.name("USER_NAME"), SQLDataType.VARCHAR(255).nullable(false), this, "");
