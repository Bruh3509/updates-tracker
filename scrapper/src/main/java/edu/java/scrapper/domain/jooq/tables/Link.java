...
public class Link extends TableImpl<LinkRecord> {
    ...
    public final TableField<LinkRecord, String> LINK_NAME =
        createField(DSL.name("LINK_NAME"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>LINK.LAST_CHECK</code>.
     */
    public final TableField<LinkRecord, Long> LAST_CHECK =
        createField(DSL.name("LAST_CHECK"), SQLDataType.BIGINT, this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function4<? super Long, ? super String, ? super Long, ? super OffsetDateTime, ? extends U> from
    ) {
