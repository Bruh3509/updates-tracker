...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> LINK_NAME = createField(DSL.name("LINK_NAME"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>LINK.LAST_CHECK</code>.
     */
    public final TableField<LinkRecord, Long> LAST_CHECK = createField(DSL.name("LAST_CHECK"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>LINK.LAST_UPDATE</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_UPDATE = createField(DSL.name("LAST_UPDATE"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
