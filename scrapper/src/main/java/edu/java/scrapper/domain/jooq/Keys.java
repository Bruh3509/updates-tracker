...
public class Keys {
    ...
    public static final ForeignKey<ChatToLinkRecord, LinkRecord> CONSTRAINT_53 = Internal.createForeignKey(ChatToLink.CHAT_TO_LINK, DSL.name("CONSTRAINT_53"), new TableField[] { ChatToLink.CHAT_TO_LINK.LINK_ID }, Keys.CONSTRAINT_2, new TableField[] { Link.LINK.LINK_ID }, true);
}
